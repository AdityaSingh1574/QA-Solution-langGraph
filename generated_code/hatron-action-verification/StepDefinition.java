...
public class StepDefinition {
    ...
    public void userIsOnTestControlScreen() {
        // This step is implicit based on the previous steps
    }
    ...
    public void verifyActionExists(String action) {
        assert implementation.verifyActionExists(action) : "Action " + action + " does not exist or is not clickable";
    }
