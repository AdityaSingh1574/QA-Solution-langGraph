...
public class Locators {
    ...
    public static By competencyFormLink = By.xpath("//a[@href='https://mymis.geminisolutions.com/AppraisalManagement/CompetencyForm']");
    public static By appraisalCycleDropdown = null;
    public static By locationDropdown = null;
    public static By verticalDropdown = null;
    public static By designationDropdown = null;
